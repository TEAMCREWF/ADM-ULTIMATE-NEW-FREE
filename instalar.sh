...
SCPresq="aHR0cHM6Ly9naXRodWIuY29tL1RFQU1DUkVXRi9BRE0tVUxUSU1BVEUtTkVXLUZSRUUvdHJlZS9tYXN0ZXIvcmVxdWVzdA=="
SUB_DOM='base64 -d'
...
fun_ip
wget -O /usr/bin/trans https://github.com/TEAMCREWF/ADM-ULTIMATE-NEW-FREE/blob/master/Install/trans &> /dev/null
msg -bar2
